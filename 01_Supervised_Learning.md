...
| **Lasso Regression**         | Performs feature selection by shrinking coefficients to zero | $\text{Cost} = RSS + \lambda \sum_{j=1}^{n}|\beta_j|$                                 | \beta_j                                                      | $ | Marketing analytics, feature selection |
